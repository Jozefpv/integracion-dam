...
const TextSection = () => {
    return (
        <div className="textSectionFont" style={{Sdisplay:"flex", flexDirection:"column", maxWidth:"700px", border:"1px solid white", padding:"10px", borderRadius:"10px", backgroundColor:"rgba(255, 255, 255, 0.5)"}}>
            <h3>Descubre La Palma</h3>
